...
def inference_video(frame):
            ...
            return first_graph, second_graph, face_positions, frame

def main():

    video_path = "/home/adriangar8/Documents/academia/CVC/hack_repo/src/data/faces/ingles/Homoeopathy in Female Problems by Dr  Meghna Shah_trimmed.mp4"
